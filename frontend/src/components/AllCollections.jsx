...
const AllCollections = () => {
    ...
    function sortCollection() {
      ...
      let categoryFiltered = sortedProducts;
        ...
        if (
          ...
          categoryFiltered = categoryFiltered.filter(
            (product) =>
              product.category == "Kids" || product.category == "Women"
          );
        } else if (
          categories.men == true &&
          categories.women == false &&
          ...
          categoryFiltered = categoryFiltered.filter(
            (product) => product.category == "Men" || product.category == "Kids" ||  product.category == "Women"
          );
        }
        ...
        if (
          ...
          subCategoryFiltered = subCategoryFiltered.filter(
            (product) =>
              product.subCategory === "Topwear" || product.subCategory === "Winterwear"
          );
        } else if (
          subCategories.Topwear &&
          subCategories.Bottomwear &&
          ...
          subCategoryFiltered = subCategoryFiltered.filter(
            (product) =>
              product.subCategory === "Topwear" || product.subCategory === "Bottomwear"
          );
        } else {
          subCategoryFiltered = subCategoryFiltered.filter(
            (product) =>
  ...
  return (
    <div>
       <div  className="flex p-3 items-center gap-4 cursor-pointer">
                <p>back</p>
